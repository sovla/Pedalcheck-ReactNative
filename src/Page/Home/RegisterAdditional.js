    ...
    return (
        <>
            ...
            <Box mg="0px 16px 20px">
                <FooterButton leftContent="다음에 입력하기" rightContent="저장하기" leftPress={() => navigation.goBack()} rightPress={onPressSave} />
            </Box>
        </>
    );
}

export const RegisterAdditionalBody = ({sex, setSex, setSelectImage, selectImage, imageType, setImageType, birthDate, setBirthDate}) => {
    const dispatch = useDispatch();
        ...
        <Container mg="0px 16px 30px">
            ...
            <Box>
                ...
                <RowBox mg="10px 0px 0px" width="100%">
                    ...
                    <CheckBox width="auto" isCheck={sex === 'woman'} setIsCheck={() => setSex('woman')} pd="0px 40px 0px 0px" isRadio>
