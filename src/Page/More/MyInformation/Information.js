            ...
            <Container>
                <Box mg="20px 0px" width={412} alignItems="center">
                    <Box
                        ...
                        <DefaultImage source={login?.mt_image ? {uri: imageAddress + login.mt_image} : profileDefault} width="80px" height="80px" />
                    </Box>
                    ...
                    {!isAdmin && (
                        <>
                            <TouchableOpacity
                                ...
                                <RowBox style={borderBottomWhiteGray} alignItems="center" justifyContent="space-between" backgroundColor="#0000" width="380px">
