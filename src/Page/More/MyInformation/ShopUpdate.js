...
export default function ShopUpdate() {
    ...
    useEffect(() => {
        if (isFocused && storeInfo) {
            ...
            const changeValue = storeInfo?.mst_holiday?.includes(',') ? storeInfo?.mst_holiday?.split(',') : [storeInfo?.mst_holiday];
        ...
        <>
            ...
            <ScrollBox ref={ref} keyboardShouldPersistTaps="handled">
                <Box alignItems="center">
                    ...
                    <DefaultInput width={'380px'} fontSize={Theme.fontSize.fs15} placeHolder="기본주소를 입력해주세요" pd="0px 0px 5px" mg="0px 0px 10px" value={shopInformation?.mst_addr1} />
                    <DefaultInput
                        width={'380px'}
                        fontSize={Theme.fontSize.fs15}
                    ...
                    />
                    <AccountInformation errorMessage={AccountErrorMessage} user={user} setUser={setUser} onPressAddImage={onPressAddImage} bankList={bankList} />
                    <Box height="20px" />
                </Box>
                <Box alignItems="center">
                    ...
                    <Box>
                        ...
                        <Photo imageCount={15} imageArray={imageArray} setImageArray={setImageArray} onPressDelete={deleteImageHandle} />
                    </Box>
                    <Box width={'380px'}>
