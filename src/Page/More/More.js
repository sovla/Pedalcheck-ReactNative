                ...
                <BetweenBox width={412} pd="20px 16px" alignItems="center">
                    <RowBox alignItems="center">
                        <Box
                            ...
                            <DefaultImage source={login?.mt_image ? {uri: imageAddress + login?.mt_image} : profileDefault} width="50px" height="50px" />
                        </Box>
        ...
        */}
                ...
                <Box pd="10px 16px 0px">
                    {menuItem.map((item, index) => (
                        <Box
                            key={item.content}
                            style={[borderBottomWhiteGray, !isLastChild(menuItem.length, index) ? {borderBottomColor: Theme.borderColor.gray} : {borderBottomColor: Theme.borderColor.whiteLine}]}>
    ...
    return (
        <BetweenBox pd="0px 16px">
            <TouchableOpacity
                ...
                <Box width="185px" height="43px" justifyContent="center" alignItems="center" borderColor={Theme.borderColor.gray} borderRadius="10px" pd="0px">
                    <RowBox alignItems="center">
