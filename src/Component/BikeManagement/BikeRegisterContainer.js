    ...
    const bikeSerialCheckHandle = () => {
        bikeSerialCheck({
            ...
            if (res.data?.data?.data !== '') {
                ...
                showToastMessage('등록 가능한 차대번호 입니다.');
            }
        });
    };
            ...
            <ScrollBox keyboardShouldPersistTaps="handled">
                <Box width={412} pd="20px 16px">
                    ...
                    <RowBox width="100%" justifyContent="space-between" mg="0px 0px 20px">
                        ...
                        <DefaultImage borderRadius="10px" source={image !== undefined ? {uri: image?.path ?? imageAddress + image} : DummyImage} width="90px" height="90px" />
                    </RowBox>
