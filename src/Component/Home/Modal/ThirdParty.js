    ...
    <>
      ...
      <Box
        ...
        <Box pd="16px" width="100%" backgroundColor={Theme.color.white} borderRadius="5px">
          ...
          <DarkText fontSize={Theme.fontSize.fs14} pd={paddingText}>
            제공된 정보는 이용자 식별, 통계 계정 연동 및 CS 등을 위해 서비스 이용기간 동안 활용/보관됩니다. 기본정보 및
            필수 제공 항목은 페달체크 서비스를 이용하기 위해 반드시 제공되어야 할 정보입니다.
          </DarkText>
          <DarkText fontSize={Theme.fontSize.fs14} pd={paddingText} fontWeight={Theme.fontWeight.bold}>
            기본 정보
          </DarkText>
          <DarkText fontSize={Theme.fontSize.fs14}>이용자 식별자, 닉네임, 프로필사진, 이메일</DarkText>
          <DarkText fontSize={Theme.fontSize.fs14} pd={paddingText} fontWeight={Theme.fontWeight.bold}>
            필수 제공 항목
          </DarkText>
          <DarkText fontSize={Theme.fontSize.fs14}>
            휴대폰번호, 이름, 정비 자전거 정보, 지역, 대표 자전거 정보, 주행거리
          </DarkText>
          <DarkText fontSize={Theme.fontSize.fs14} pd={paddingText}>
