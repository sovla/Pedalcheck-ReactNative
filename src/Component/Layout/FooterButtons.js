            ...
            {menuArray.map((item, index) => {
                ...
                return (
                    <TouchableOpacity
                        ...
                        <Box width={boxWidth} backgroundColor="rgba(0,0,0,0)" height="100%" justifyContent="flex-end" alignItems="center" pd="0px 0px 10px">
                            <DefaultImage source={isOn ? item.imageOn : item.imageOff} width={index !== 1 ? '22px' : '32px'} height="22px" resizeMode="contain" />
