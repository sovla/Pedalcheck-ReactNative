...
export const bankList = [
  {label: '은행을 선택해주세요.', value: '은행을 선택해주세요.', bankCode: '00'},
  {label: '기업은행', value: '기업은행', bankCode: '03'},
  {label: '국민은행', value: '국민은행', bankCode: '04'},
  {label: '외환은행', value: '외환은행', bankCode: '05'},
  {label: '수협중앙회', value: '수협중앙회', bankCode: '07'},
  {label: '농협중앙회', value: '농협중앙회', bankCode: '11'},
  {label: '우리은행', value: '우리은행', bankCode: '20'},
  {label: 'SC제일은행', value: 'SC제일은행', bankCode: '23'},
  {label: '대구은행', value: '대구은행', bankCode: '31'},
  {label: '부산은행', value: '부산은행', bankCode: '32'},
  {label: '광주은행', value: '광주은행', bankCode: '34'},
  {label: '한국씨티은행', value: '한국씨티은행', bankCode: '53'},
  {label: '우체국', value: '우체국', bankCode: '71'},
  {label: '하나은행', value: '하나은행', bankCode: '81'},
  {label: '통합신한은행', value: '통합신한은행', bankCode: '88'},
  {label: '동양종합금융증권', value: '동양종합금융증권', bankCode: 'D1'},
  {label: '현대증권', value: '현대증권', bankCode: 'D2'},
  {label: '미래에셋증권', value: '미래에셋증권', bankCode: 'D3'},
  {label: '한국투자증권', value: '한국투자증권', bankCode: 'D4'},
  {label: '우리투자증권', value: '우리투자증권', bankCode: 'D5'},
  {label: '하이투자증권', value: '하이투자증권', bankCode: 'D6'},
  {label: 'HMC 투자증권', value: 'HMC 투자증권', bankCode: 'D7'},
  {label: 'SK 증권', value: 'SK 증권', bankCode: 'D8'},
  {label: '대신증권', value: '대신증권', bankCode: 'D9'},
  {label: '하나대투증권', value: '하나대투증권', bankCode: 'DA'},
  {label: '굿모닝신한증권', value: '굿모닝신한증권', bankCode: 'DB'},
  {label: '동부증권', value: '동부증권', bankCode: 'DC'},
  {label: '유진투자증권', value: '유진투자증권', bankCode: 'DD'},
  {label: '메리츠증권', value: '메리츠증권', bankCode: 'DE'},
  {label: '신영증권', value: '신영증권', bankCode: 'DF'},
];
